                                    ...
                                    IXncfRazorRuntimeCompilation  //赋能 RazorPage 运行时编译
    {
        ...
        public List<AreaPageMenuItem> AreaPageMenuItems => new List<AreaPageMenuItem>() {
                         new AreaPageMenuItem(GetAreaHomeUrl(),"首页","fa fa-laptop"),
			 			 new AreaPageMenuItem(GetAreaUrl($"/Admin/BidManager/DatabaseSample"),"数据库操作示例","fa fa-bookmark-o")
			 		};
        ...
        public string LibraryPath => Path.GetFullPath(Path.Combine(SiteConfig.WebRootPath, "..", "..", "HSBG.Xncf.BidManager"));
        #endregion
    }
}
