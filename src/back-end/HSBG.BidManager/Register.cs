...
using BidManager.Models;
using BidManager.OHS.Local.AppService;
using Senparc.Ncf.Core.Models;
using Senparc.Ncf.Database;
using Senparc.Ncf.XncfBase.Database;
using BidManager.Models.DatabaseModel.Dto;

namespace BidManager
{
    [XncfRegister]
    public partial class Register : XncfRegisterBase, IXncfRegister
    {
        ...
        public override string Name => "BidManager";

        public override string Uid => "6A26F957-FF05-4A81-825D-9AD663BA7C2A";//必须确保全局唯一，生成后必须固定，已自动生成，也可自行修改

        public override string Version => "0.1";//必须填写版本号

        public override string MenuName => "标书管理";

        public override string Icon => "el-icon-s-order";

        public override string Description => "标书制作管理系统插件模块";
